...
void ultrasensore()
{
    ...
    min_val=100;//più basso e più l'oggetto devo metterlo vicino
    delay(500);
    j=60;
    int index=0;
    for (i=60; i<=180;i+=2,j++)
    {
        ...
        if(primavolta==false)//Se il bersaglio è ancora li e non si muove non parte da 60° ma riparte dalla posizione dell'ultimo bersaglio
        {
          primavolta=true;
          i=i2;
          j=j2;
